...
-  electronic key that enables a user to authenticate and prove his identity

2. What steps can you take in your web apps to keep your data secure?
- To apply authentication, and have input validation. Also backing your data up as well.
3. Describe how web servers work.
- a web server is a computer that stores web server software and a website's component files. The basic objective of the web server is to store, process and deliver web pages to the users by using HTTP.
